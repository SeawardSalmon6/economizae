    ...
    <section className={styles.hero}>
      <div className={styles.heroContent}>
        ...
        <div className={styles.searchBar}>
          ...
          >
            <path
              d="M25 25L19.0663 19.0663M19.0504 4.09741C23.1803 8.22729 23.1803 14.9205 19.0504 19.0504C14.9205 23.1803 8.22729 23.1803 4.09741 19.0504C-0.0324707 14.9205 -0.0324707 8.22729 4.09741 4.09741C8.22729 -0.0324707 14.9205 -0.0324707 19.0504 4.09741Z"
              stroke="#05833E"
              strokeWidth="2"
              strokeLinecap="round"
